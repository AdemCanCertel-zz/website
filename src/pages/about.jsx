...
export default function AboutPage() {
    ...
    <main>
        ...
        <Tooltip title="Follow me on GitHub!" animation="shift" theme="light"><a href="https://github.com/eggsy/" target="_blank">
